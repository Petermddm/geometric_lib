...
Данный проект представляет собой набор функций для вычисления перииетра и площади различных фигур. 
    
Проект состоит из модулей, каждый из которых отвечает за работу с определенной геометрической фигурой.

В текущей версии реализованы модули для работы со следующими фигурам: окружность, прямоугольник, квадрат, треугольник.
